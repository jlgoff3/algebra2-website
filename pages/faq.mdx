...
Tests are graded with the following rubric: [Tests](https://docs.google.com/document/d/1QaCUXfRbc79vPHXj529y_8ODSwO231aziewdPndzuEM/edit?usp=sharing)
...
You are **not** permitted to use Photomath, Mathway, or any other step-by-step solvers which do the work for you. You are **not** permitted to use ChatGPT or other generative AI tools to do work for you. All work submitted must be your own.
